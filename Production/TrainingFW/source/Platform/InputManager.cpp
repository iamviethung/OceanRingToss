...
void InputManager::updateSensorEvent(short posX, short posY, short posZ)
{
	m_DirectionEvent = SensorEvent(posX, posY, posZ);
}
...
SensorEvent InputManager::getCoorSensorEvent(){
	return m_DirectionEvent;
}